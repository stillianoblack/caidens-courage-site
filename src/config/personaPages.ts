...
export const PARENTS_PAGE: PersonaPageConfig = {
  ...
  benefits: [
    ...
    'Encourages focus and resilience',
    'Creates meaningful parent-child time',
    'Supports positive routines at home',
  ],
  whatsIncluded: [
    'Family activities',
    'Coloring pages',
  ...
  pricing: [
    {
      ...
      cta: { label: 'Start with Family Portal', href: '/contact?subject=Family%20Portal%20Access' },
    },
    {
      title: 'Digital Book + Family Portal',
      price: '$129/year',
      includes: [
        'Everything in Family Portal',
        'Digital storybook + read-along',
        'Character lessons',
      ...
      badges: ['Best value'],
      featured: true,
      cta: { label: 'Join Family and Save', href: '/contact?subject=Family%20Portal%20Waitlist' },
    },
  ],
  pricingFooterNotes: ["Cancel anytime. You’ll keep access to all resources and downloads as long as your subscription is active."],
