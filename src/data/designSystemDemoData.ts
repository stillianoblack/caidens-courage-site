...
export const DEMO_ROSTER_ROWS: PilotRosterRow[] = [
  {
    ...
    hasPin: true,
    pinLastRotatedAt: '2026-06-01T12:00:00.000Z',
    familyClaimCode: 'CLAIM-DEMO-001',
    familyClaimUrl: 'https://example.com/claim?code=CLAIM-DEMO-001',
  },
  {
