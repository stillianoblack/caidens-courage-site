        ...
        makeZekeQuestion(
          {
            ...
            choices: ['Pass the ball', 'Keep it forever', 'Hide the ball', 'Stop the game'],
            correctIndex: 0,
        ...
        makeZekeQuestion(
          {
            ...
            choices: [
              ...
              'Only pass when someone yells',
              'Keep the ball in your backpack',
              'Run away with it',
            ],
            correctIndex: 0,
        ...
        makeZekeQuestion(
          {
            ...
            choices: [
              ...
              'Passing is never allowed when running',
            ],
            correctIndex: 0,
        ...
        makeZekeQuestion(
          {
            ...
            choices: [
              ...
              'Always shoot because he touched the ball last',
        ...
        makeZekeQuestion(
          {
            ...
            choices: [
              ...
              'He gives up because he is scared',
              'He only cares about being liked',
            ],
            correctIndex: 0,
