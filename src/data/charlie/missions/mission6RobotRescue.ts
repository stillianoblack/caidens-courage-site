        ...
        makeCharlieQuestion(
          {
            ...
            choices: [
              ...
              'Made the robot dizzy on purpose',
        ...
        makeCharlieQuestion(
          {
            ...
            choices: [
              ...
              'Assume the robot is fixed forever',
            ],
            correctIndex: 0,
        ...
        makeCharlieQuestion(
          {
            ...
            choices: [
              ...
              'Restart forever without checking',
              'Blame the robot\'s personality',
            ],
            correctIndex: 0,
        ...
        makeCharlieQuestion(
          {
            ...
            choices: [
              ...
              'Only that robots are confusing',
              'Nothing — move on',
              'That debugging should never be written down',
            ],
            correctIndex: 0,
