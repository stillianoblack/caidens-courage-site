        ...
        makeCharlieQuestion(
          {
            ...
            choices: [
              ...
              'Yes — science is over forever',
              'Yes — volcanoes are impossible',
              'No — because bubbles are always perfect',
            ],
            correctIndex: 0,
        ...
        makeCharlieQuestion(
          {
            ...
            choices: [
              ...
              'Hide the results from his team',
            ],
            correctIndex: 0,
        ...
        makeCharlieQuestion(
          {
            ...
            choices: [
              ...
              'So the volcano feels fancy',
              'So the table claps',
              'So he never has to test again',
            ],
            correctIndex: 0,
        ...
        makeCharlieQuestion(
          {
            ...
            choices: [
              ...
              'Measuring never helps',
              'Volcanoes only work on Mondays',
              'Bubbles are random and unknowable',
            ],
            correctIndex: 0,
        ...
        makeCharlieQuestion(
          {
            ...
            choices: [
              ...
              'Charts mean he never has to iterate',
            ],
            correctIndex: 0,
