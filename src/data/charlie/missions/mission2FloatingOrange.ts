        ...
        makeCharlieQuestion(
          {
            ...
            choices: [
              ...
              'The orange is scared of water',
              'The bowl likes oranges',
              'The peel is magic armor',
            ],
            correctIndex: 0,
        ...
        makeCharlieQuestion(
          {
            ...
            choices: [
              ...
              'Oranges float because water is afraid of fruit',
              'Peeling always makes things heavier than a backpack',
              'The bowl chooses favorites',
            ],
            correctIndex: 0,
...
registerCharlieAdaptiveMission(CHARLIE_MISSION_2_FILE);
