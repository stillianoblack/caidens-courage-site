  ...
  gradeContent: {
    '2-3': bandContent(
      ...
      [
        ...
        {
          id: 'cq2-23-q4',
          question: 'Caiden is reading during camp quiet time. His friend keeps whispering jokes. What should he do?',
          scenarioTag: 'QUIET FOCUS',
          scenarioAccent: 'distraction',
          options: [
            { id: 'a', label: 'Whisper back louder' },
            { id: 'b', label: 'Leave and run outside' },
            { id: 'c', label: 'Put the book down and play' },
            { id: 'd', label: 'Use a quiet signal that he is focusing and keep reading' },
          ],
          correctAnswer: 'd',
          explanation: 'A calm signal protects reading time without starting a bigger distraction.',
          hint: 'How can Caiden stay on task without making things louder?',
          skillTags: [SKILL],
        },
        {
          id: 'cq2-23-q5',
          question: 'Caiden is practicing lines for the camp skit. Music from the next room is loud. What helps most?',
          scenarioTag: 'NOISE BLOCK',
          scenarioAccent: 'small-step',
          options: [
            { id: 'a', label: 'Give up practicing' },
            { id: 'b', label: 'Turn the music louder' },
            { id: 'c', label: 'Move to a quieter spot or use headphones' },
            { id: 'd', label: 'Practice while shouting over the noise' },
          ],
          correctAnswer: 'c',
          explanation: 'Changing the environment reduces the noise pulling his attention away.',
          hint: 'What can Caiden change about where or how he practices?',
          skillTags: [SKILL],
        },
      ],
    ),
    '4-5': bandContent(
      ...
      [
        ...
        },
        {
          id: 'cq2-45-q4',
          scenarioText:
            'Caiden studies best in 15-minute blocks. He has 45 minutes and three subjects. His phone buzzes every few minutes.',
          question: 'Which plan protects his focus?',
          scenarioTag: 'FOCUS BLOCKS',
          scenarioAccent: 'timer',
          options: [
            { id: 'a', label: 'Keep the phone on the desk for quick breaks' },
            { id: 'b', label: 'Switch subjects every 2 minutes' },
            { id: 'c', label: 'Put the phone in another room and do one 15-minute block per subject' },
            { id: 'd', label: 'Study with videos playing for company' },
          ],
          correctAnswer: 'c',
          explanation: 'Removing the phone and using timed blocks keeps attention on one subject at a time.',
          hint: 'What removes the buzzes and limits task switching?',
          skillTags: [SKILL, 'Planning', 'Focus'],
          metadata: caidenBandMetadata('4-5', 'Planning', MODULE_ID, 'intermediate'),
        },
        {
          id: 'cq2-45-q5',
          scenarioText:
            'Caiden is writing in his camp journal. His tablet shows game alerts. He wants to finish the entry before free time ends.',
          question: 'What is the best focus move?',
          scenarioTag: 'ALERT OFF',
          scenarioAccent: 'distraction',
          options: [
            { id: 'a', label: 'Check every alert quickly' },
            { id: 'b', label: 'Write one word, then check alerts' },
            { id: 'c', label: 'Leave the tablet open for inspiration' },
            { id: 'd', label: 'Silence alerts and write for 10 focused minutes' },
          ],
          correctAnswer: 'd',
          explanation: 'Silencing alerts stops the ping-pong attention and gives the journal a real focus window.',
          hint: 'How can Caiden stop the tablet from interrupting his writing?',
          skillTags: [SKILL, 'Focus', 'Executive Function'],
          metadata: caidenBandMetadata('4-5', 'Focus', MODULE_ID, 'intermediate'),
        },
      ],
    ),
    '6-8': bandContent(
      ...
      [
        ...
        {
          id: 'cq2-68-q4',
          question: 'Caiden is editing a camp video. Notifications pop up from three apps. What should he do?',
          scenarioTag: 'EDIT MODE',
          scenarioAccent: 'distraction',
          options: [
            { id: 'a', label: 'Reply to each notification between edits' },
            { id: 'b', label: 'Edit with all apps visible for multitasking' },
            { id: 'c', label: 'Stop editing until tomorrow' },
            { id: 'd', label: 'Close non-essential apps and set a focus timer' },
          ],
          correctAnswer: 'd',
          explanation: 'Editing needs sustained attention. Closing apps and timing the session protects that focus.',
          hint: 'What removes interruptions during detailed work?',
          skillTags: [SKILL],
        },
        {
          id: 'cq2-68-q5',
          question: 'Why can background conversations hurt focus during complex tasks?',
          scenarioTag: 'ATTENTION COST',
          scenarioAccent: 'reflection',
          options: [
            { id: 'a', label: 'They always boost creativity' },
            { id: 'b', label: 'They make tasks disappear' },
            { id: 'c', label: 'They compete for the same attention resources' },
            { id: 'd', label: 'They guarantee better memory' },
          ],
          correctAnswer: 'c',
          explanation: 'Your brain has limited attention. Background talk pulls resources away from the hard task.',
          hint: 'What happens when two things demand your attention at once?',
          skillTags: [SKILL],
        },
      ],
    ),
