...
export const CAIDEN_QUEST_1_K1: CaidenGradeContent = {
  ...
  questions: [
    ...
    },
    {
      id: 'cq1-k1-q4',
      question: 'What should Caiden do first?',
      scenarioText: 'Cleanup time starts soon. Caiden wants to show B-4 his comic, but art supplies are still on the table.',
      scenarioTag: 'CLEANUP FIRST',
      scenarioAccent: 'small-step',
      options: [
        { id: 'show', label: 'Show the comic right away' },
        { id: 'tidy', label: 'Put away the art supplies' },
        { id: 'draw', label: 'Start a new drawing' },
        { id: 'sit', label: 'Sit and wait' },
      ],
      correctAnswer: 'tidy',
      explanation: 'Putting supplies away first keeps cleanup on track.',
      hint: 'What job is due soon?',
      skillTags: ['Prioritization'],
      metadata: legacyMeta('cq1-k1-q4', 'caidenLegacyK1Bands.ts', ['Prioritization']),
    },
    {
      id: 'cq1-k1-q5',
      question: 'What should Caiden focus on first?',
      scenarioText: 'The counselor is sharing the camp plan at circle time. Caiden wants to fix his backpack zipper.',
      scenarioTag: 'LISTEN UP',
      scenarioAccent: 'priority',
      options: [
        { id: 'zipper', label: 'Fix the zipper now' },
        { id: 'listen', label: 'Listen to the camp plan' },
        { id: 'friend', label: 'Talk to a friend' },
        { id: 'look', label: 'Look out the window' },
      ],
      correctAnswer: 'listen',
      explanation: 'Directions at circle time help Caiden know what to do next.',
      hint: 'What is the main job right now?',
      skillTags: ['Prioritization'],
      metadata: legacyMeta('cq1-k1-q5', 'caidenLegacyK1Bands.ts', ['Prioritization']),
    },
  ],
};
...
export const CAIDEN_QUEST_2_K1: CaidenGradeContent = {
  ...
  questions: [
    ...
    {
      id: 'cq2-k1-q4',
      question: 'What helps Caiden focus?',
      scenarioText: 'During camp craft time, Caiden is gluing paper. A noisy game starts nearby.',
      scenarioTag: 'CRAFT FOCUS',
      scenarioAccent: 'distraction',
      options: [
        { id: 'join', label: 'Join the noisy game' },
        { id: 'glue', label: 'Cover his ears and keep gluing' },
        { id: 'throw', label: 'Throw the glue stick' },
        { id: 'run', label: 'Run away from craft time' },
      ],
      correctAnswer: 'glue',
      explanation: 'Staying with his craft while blocking noise protects focus.',
      hint: 'How can Caiden stay on his project?',
      skillTags: ['Attention Control'],
      metadata: legacyMeta('cq2-k1-q4', 'caidenLegacyK1Bands.ts', ['Attention Control']),
    },
    {
      id: 'cq2-k1-q5',
      question: 'What is a focus-friendly choice?',
      scenarioText: 'Caiden is listening to B-4\'s story. His fidget toy keeps spinning on the table.',
      scenarioTag: 'FIDGET AWAY',
      scenarioAccent: 'small-step',
      options: [
        { id: 'spin', label: 'Spin the toy louder' },
        { id: 'pocket', label: 'Put the toy in his pocket' },
        { id: 'throw', label: 'Throw the toy' },
        { id: 'talk', label: 'Talk over the story' },
      ],
      correctAnswer: 'pocket',
      explanation: 'Putting the toy away helps his ears and eyes stay on the story.',
      hint: 'What keeps the toy from pulling attention away?',
      skillTags: ['Attention Control'],
      metadata: legacyMeta('cq2-k1-q5', 'caidenLegacyK1Bands.ts', ['Attention Control']),
    },
  ],
};
...
export const CAIDEN_QUEST_3_K1: CaidenGradeContent = {
  ...
  questions: [
    ...
    },
    {
      id: 'cq3-k1-q4',
      question: 'What should Caiden do?',
      scenarioText: 'The big hand on the clock is almost at the line. Recess starts soon.',
      scenarioTag: 'CLOCK WATCH',
      scenarioAccent: 'timer',
      options: [
        { id: 'chat', label: 'Keep chatting' },
        { id: 'lineup', label: 'Line up when the clock shows it is time' },
        { id: 'hide', label: 'Hide under a table' },
        { id: 'nap', label: 'Take a nap' },
      ],
      correctAnswer: 'lineup',
      explanation: 'Watching the clock and lining up on time keeps the group on schedule.',
      hint: 'What does the clock tell Caiden to do?',
      skillTags: ['Time Management'],
      metadata: legacyMeta('cq3-k1-q4', 'caidenLegacyK1Bands.ts', ['Time Management']),
    },
    {
      id: 'cq3-k1-q5',
      question: 'What fits the time?',
      scenarioText: 'Caiden has time for one quick job before snack: wash his hands or build a tall tower.',
      scenarioTag: 'QUICK JOB',
      scenarioAccent: 'small-step',
      options: [
        { id: 'tower', label: 'Build a tall tower' },
        { id: 'hands', label: 'Wash his hands' },
        { id: 'both', label: 'Try to do both at once' },
        { id: 'neither', label: 'Do neither' },
      ],
      correctAnswer: 'hands',
      explanation: 'Washing hands is quick and gets him ready for snack on time.',
      hint: 'Which job is small enough to finish before snack?',
      skillTags: ['Time Management'],
      metadata: legacyMeta('cq3-k1-q5', 'caidenLegacyK1Bands.ts', ['Time Management']),
    },
  ],
};
