...
export const FAMILY_PORTAL_SEARCH_RESOURCES: PortalSearchResource[] = [
  ...
  {
    id: 'family-dr-victoria',
    title: "Dr. Victoria\u2019s Understanding Different Minds",
    description: 'Parent training on looking beyond behavior',
    category: 'Parent Corner',
    tags: ['dr victoria', 'training', 'parents', 'behavior', 'adult'],
...
export const FACILITATOR_PORTAL_SEARCH_RESOURCES: PortalSearchResource[] = [
  ...
  {
    id: 'facilitator-dr-victoria',
    title: "Dr. Victoria\u2019s Understanding Different Minds",
    description: 'Adult training on looking beyond behavior',
    category: 'Adult Training',
    tags: ['dr victoria', 'training', 'adult', 'behavior', 'facilitator'],
